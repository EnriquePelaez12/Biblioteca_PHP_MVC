...
$('.FormularioAjax').submit(function(e){
	...
	var accion=form.attr('action');//se se quiere mandar los datos de un formulario
	var metodo=form.attr('method');
	var respuesta=form.children('.RespuestaAjax');

	var msjError="<script>swal('Ocurrió un error inesperado','Por favor recargue la página','error');</script>";
	var formdata = new FormData(this);//array de datos que se estan enviando via ajax
	...
	swal({
		...
		$.ajax({
			...
			contentType: false,
			processData: false,
			xhr: function(){//muestra el porsentaje de envio
...
//Aqui termina el codigo que se agrego
